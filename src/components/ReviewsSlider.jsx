...
const ReviewsCard = ({ info }) => {
  return (
    <div className=" border-primary-darken border-2 w-[5wv] px-4 py-3 rounded-[24px] [10px] flex flex-col gap-2 min-w-[300px] flex-wrap mr-6">
      <h4 className="text-xl font-semibold">{info.username}</h4>
      <p>{info.content} </p>
